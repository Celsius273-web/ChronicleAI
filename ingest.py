...
#         news_dict = []
#         for item in data:
#             news_dict.append([item['name'], item['url']])
#     return news_dict
#
#
# def fetchText(url):
...
#         # You may need to adjust the selectors based on the actual HTML structure of the articles
...
#     try:
#         with open('data/articles.json', 'w') as fd:
